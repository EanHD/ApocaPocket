...
**Stay with vehicle. 75% of stranded motorist deaths occur when people leave.**

## Stay vs Go

Stay if: blizzard/whiteout conditions | night | unfamiliar area | >1 mile to help | elderly, children, or injured aboard.
Go only if: building visible and <1 mile in clear daytime conditions | vehicle unsafe (fire, flood, avalanche path) | cell service confirmed help is coming to your exact location.

## Engine and CO Safety
...
- Remove rubber floor mats; place on exterior roof over passenger compartment (reduces radiant heat loss)
- Stuff newspaper, cardboard, or clothing in door panels (reduces drafts)
- Cover windows with emergency blankets (silver side IN), cardboard, or clothing
- Leave driver's window partially clear (visibility for rescuers)
- Layer all available clothing; hat is critical (30-40% heat loss through head)
...
Night:
- Dome light on when hearing approaching vehicles (conserve battery otherwise)
- Flashlight: circular wave = universal distress; SOS = 3 short, 3 long, 3 short
- Road flares: place 50 ft front and rear, visible 1-3 miles, last 15-30 min each
...
- Engine 10 min/hr maintains charge and provides heat

## Survival Kit

- 2-3 mylar emergency blankets; sleeping bag or heavy blanket; extra hat, gloves, socks
- High-calorie snacks (nuts, granola, chocolate); 2-4 L water; metal can for melting snow
- LED flashlight; road flares (3-5); bright orange cloth; whistle
- Ice scraper; collapsible shovel; jumper cables; tow strap; multi-tool
- First aid kit; cell phone car charger; matches and lighter
