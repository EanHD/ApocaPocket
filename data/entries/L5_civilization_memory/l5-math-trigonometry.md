...
region_relevance:
- global
summary: Sine, cosine, and tangent ratios for calculating angles, heights, and distances
...
warnings:
- Small angle measurement errors multiply over distance.
- Always verify with a second method when possible.
related_entries:
- l5-math-foundations
...
## Overview
Sine, cosine, and tangent ratios for calculating angles, heights, and distances in construction and surveying.
