...
region_relevance:
- global
summary: Principles of fluid flow for designing water systems, hydraulic presses,
  and simple pumps.
steps:
...
warnings:
- Water hammer from sudden valve closure can burst pipes.
- Ensure intake screens to prevent debris from jamming pumps.
related_entries:
- l5-mechanical-engineering-basics
- l5-mech-thermodynamics-basics
...
## Overview
Principles of fluid flow for designing water systems, hydraulic presses, and simple pumps.
