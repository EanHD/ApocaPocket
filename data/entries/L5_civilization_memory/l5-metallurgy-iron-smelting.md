...
region_relevance:
- global
summary: How to produce usable iron from ore using a bloomery furnace with charcoal
  fuel.
steps:
- 'Identify iron ore: look for heavy, reddish-brown rocks (hematite, magnetite, bog
  iron).'
- Build a bloomery furnace from clay/stone, ~1m tall with tuyere (air inlet) near
  base.
...
## Overview
How to produce usable iron from ore using a bloomery furnace with charcoal fuel.

## Step-by-step
1. Identify iron ore: look for heavy, reddish-brown rocks (hematite, magnetite, bog iron).
