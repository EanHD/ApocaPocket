...
region_relevance:
- global
summary: Understanding how materials respond to loads, and how to apply safety factors
  to prevent failure.
steps:
...
## Overview
Understanding how materials respond to loads, and how to apply safety factors to prevent failure.

## Step-by-step
1. Define stress (force/area) and strain (deformation/original length).
