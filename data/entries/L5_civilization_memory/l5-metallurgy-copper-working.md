...
region_relevance:
- global
summary: Working native copper and smelting copper ore for tools, vessels, and eventually
  bronze alloys.
steps:
- Find native copper nuggets in streambeds or green-stained rocks (malachite, azurite)
  for ore.
...
## Overview
Working native copper and smelting copper ore for tools, vessels, and eventually bronze alloys.
