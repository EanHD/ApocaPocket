...
- 'PRE-FILTRATION (critical for filter life): Turbid/muddy water clogs filters rapidly. ALWAYS pre-filter: 1) Let water settle 2-4 hours in container, decant clear water from top. 2) Strain through cloth (bandana, t-shirt, coffee filter) 2-3 times. 3) Use pre-filter screen if included with commercial filter. Pre-filtering extends filter life 300-500%. In emergency, pre-filter even if takes extra time.'
- 'IMPROVISED SAND FILTER (removes sediment + some bacteria): Requires: 5-gallon bucket or cut plastic bottle, gravel (2-3 layers: fist-sized, pebble, fine gravel), sand (fine grain, clean, 8-12 inches deep), charcoal (activated if possible, crushed to pea-size, 4-6 inches), cloth (bottom layer to hold materials). Construction: Bottom to top layers: cloth, fine gravel (2 inches), coarse gravel (2 inches), sand (8-12 inches, most critical layer), crushed charcoal (4-6 inches), gravel (2 inches). Total depth: 16-24 inches. Pour water slowly into top, collect from bottom spout/hole. First 2-3 liters flush the system (discard). Flow rate: 1 quart per 10-15 minutes. EFFECTIVENESS: removes 90-95% sediment, 50-70% bacteria, minimal protozoa removal. MUST boil or chemically treat filtered water after.'
...
4. **Sand - 8-12 inches** (primary filtration)
5. Crushed charcoal - 4-6 inches (taste/odor)
6. Top gravel - 2 inches (pre-filter)

**Container:** 5-gal bucket or cut 2-liter bottle  
**Flow rate:** 1 quart per 10-15 minutes  
...
2. **Filter:** Commercial or improvised (removes protozoa/bacteria)
3. **Disinfect:** Boil or chemical (kills viruses + remaining pathogens)

**Total time:** 35-45 minutes for 1 liter  
