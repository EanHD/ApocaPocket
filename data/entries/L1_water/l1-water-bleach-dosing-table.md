...
summary: Household bleach (sodium hypochlorite) is the most widely available chemical water disinfectant. Correct dosing depends on bleach concentration and water turbidity. Too little fails to kill pathogens;
  too much is toxic.
warnings:
...
- 'Pool shock (calcium hypochlorite, 68%) for long-term storage: dissolve 1 heaping teaspoon in 2 gallons water to make stock solution (~500ppm). Then treat drinking water with this stock solution at same
  rate as bleach.'
