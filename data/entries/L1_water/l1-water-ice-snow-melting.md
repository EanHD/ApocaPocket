...
category: "L1"
subcategory: "water"
tags: ['water', 'snow', 'ice', 'melting', 'cold-weather', 'hypothermia']
confidence: "high"
region: "global"
sources:
...
NEVER eat snow directly (hypothermia, dehydration, 2°F core temp drop/lb). Ice: 2x more water/volume than snow. Methods: fire (layer ice/water), body heat (bottle in bag), solar (dark container). Snow purity: avoid yellow/brown/pink, top layer, test for dirt. Clear ice safer. Fuel efficiency: start with water, add snow. Disinfect after melting. 3-4L/day needed in cold.
