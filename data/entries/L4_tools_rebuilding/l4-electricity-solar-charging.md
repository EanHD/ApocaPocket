...
steps:
- 'SYSTEM SIZING: calculate daily watt-hours needed. Example: LED light (5W x 5hrs = 25Wh) + phone charging (10W x 2hrs = 20Wh) + radio (2W x 3hrs = 6Wh) = 51Wh/day. Add 30% for losses = 66Wh/day needed.'
...
- 'BATTERY SIZING: store 2-3 days of power for cloudy periods. 66Wh x 3 days = 198Wh storage. For 12V battery: 198Wh / 12V = 16.5Ah. But lead-acid batteries should only discharge to 50%: need 33Ah. A standard
...
- 'Panel angle: face toward the equator (south in Northern Hemisphere, north in Southern). Tilt angle ~ your latitude for annual average. Steeper in winter (+15 deg), flatter in summer (-15 deg). Clean panel
