...
region_relevance:
- global
summary: Constructing bow drills and pump drills for fire-starting, hole-drilling,
  and rotary work.
steps:
- 'Bow drill components: bow (curved stick + cordage), spindle (straight hardwood),
  fireboard (softwood), handhold (hardwood/stone).'
- Carve a notch in the fireboard to collect hot dust; the spindle socket should be
  a small depression.
- Wrap cordage once around spindle; press down with handhold while sawing bow back
  and forth.
...
## Overview
Constructing bow drills and pump drills for fire-starting, hole-drilling, and rotary work.

## Step-by-step
1. Bow drill components: bow (curved stick + cordage), spindle (straight hardwood), fireboard (softwood), handhold (hardwood/stone).
