...
- Never let critical meds drop below a 7-day supply
- Insulin: keep cool with evaporative wrap if no refrigeration
- Epinephrine: keep near body temp, away from heat and freezing
- Inhalers: check expiry, carry 2 if possible
- Log doses: time, amount, and who administered
- Prioritize: insulin > cardiac meds > seizure meds > others
...
These conditions = top evacuation priority:
- Insulin-dependent diabetes with less than 3 days supply
- Active heart failure or recent cardiac event
- Asthma requiring daily rescue inhaler use
- Seizure disorder without a 48-hr medication buffer
Mark their go-bag. Load them first.

## Documentation to Carry

One laminated card per person:
- Diagnosis and medications with dose and frequency
