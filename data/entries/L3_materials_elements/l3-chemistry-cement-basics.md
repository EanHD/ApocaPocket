...
- Limestone must be heated to 900 degC (1650 degF)  -  requires a sustained kiln fire for 24-72 hours
...
- 'SOURCE LIMESTONE: identify limestone  -  reacts with acid (vinegar fizzes on it), gray-white, relatively soft (scratches with steel knife). Chalk, seashells, coral, and marble also work. Collect fist-sized
  pieces.'
- 'BURN TO QUICKITE: build a kiln  -  stack limestone chunks over a fire pit, alternating layers of limestone and firewood. Or build a simple shaft kiln from clay bricks. Burn at high heat (900 degC+) for 24-72
