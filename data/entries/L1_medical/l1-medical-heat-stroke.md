...
diagram: diagrams/heat-stroke-treatment.svg
---
...
- Add pinch of salt if only plain water available
- Heat stroke: NO oral fluids until mental status clears
- Giving fluids to altered patient risks aspiration (choking to death)
...
- Heat stroke: evacuate immediately to hospital
- Heat exhaustion not improving in 2-4 hours: evacuate
- Cannot keep fluids down (vomiting): evacuate for IV access
- Seizures or unconsciousness: immediate evacuation
- Continue all cooling measures throughout transport
