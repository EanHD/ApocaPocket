...
**Priority: HIGH** | Rotate crops to break pest cycles, build soil, and increase yields 20-30% without external inputs.
...
- Pests and disease build up in soil (host always present).
- Depletes specific nutrients.
- Yields decline each year.

Rotation breaks these cycles and improves soil year over year.
...
Legume roots host Rhizobium bacteria in nodules. Bacteria convert atmospheric N2 into ammonia the plant uses. When legume is tilled in, nitrogen releases to soil for next crop.

**Nitrogen output by crop**:
- Peas: 50-80 lbs N/acre.
- Fava beans: 80-100 lbs N/acre.
- Crimson clover (cover crop): 100-150 lbs N/acre.
- Hairy vetch (cover crop): 100-200 lbs N/acre.

**Best practice**: till legume residue just before flowering (maximum nitrogen, most tender).
...
- Clubroot (brassica): 7-10 years.
- Verticillium wilt: 5-7 years.
- Nematodes: 3-5 years.

When rotation alone is insufficient: solarize soil (clear plastic, 4-6 weeks summer) or add compost (beneficial microbes outcompete pathogens).

---

## Cover Crops

Grow between cash crops to never leave soil bare.

**Nitrogen-fixing (after heavy feeders)**:
- Crimson clover, hairy vetch, field peas.

**Carbon-building (after any crop)**:
- Winter rye, oats, buckwheat.

**Biofumigant (before nightshades)**:
...
5. Wait 2-4 weeks before planting next cash crop.

---

## Companion Planting

**Three Sisters** (same bed):
- Corn + beans (climb corn, fix nitrogen) + squash (ground cover, suppress weeds).

**Pest deterrents**:
- Marigolds near tomatoes: repel aphids and whiteflies.
- Basil near tomatoes: repel hornworms.
...
- Same crop same bed each year: 4-year minimum rotation.
...
Perennials (asparagus, rhubarb, artichoke, herbs) cannot rotate. Solutions:
- Dedicate separate beds to perennials outside the rotation.
- Place perennials at garden edges.
- Use food forest system for perennials; rotation beds for annuals.
