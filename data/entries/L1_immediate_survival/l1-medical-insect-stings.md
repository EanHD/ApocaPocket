...
## Overview
Managing dangerous insect stings and bites including bees, spiders, scorpions, and ticks.

## Step-by-step
1. Remove stinger by scraping sideways (do not squeeze with tweezers).
2. Clean bite/sting site with soap and water.
3. Apply cold compress to reduce swelling and pain.
4. For ticks: grasp close to skin with fine tweezers, pull straight out steadily.
5. Monitor for systemic reactions (spreading rash, fever, difficulty breathing).
