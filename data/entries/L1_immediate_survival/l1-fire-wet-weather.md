...
- 'TOP-DOWN FIRE LAY: lay largest fuel on platform first (wrist-thick pieces), then medium kindling perpendicular on top, then small kindling, then tinder on the very top. Light the tinder. Fire burns downward,
  drying each layer before igniting it. This is the most reliable wet-weather technique.'
- 'FEATHER STICKS: using a knife, shave long thin curls on a dry stick without detaching them. Create 3-5 feather sticks with 15-20 curls each. These catch flame from even weak ignition sources and are
