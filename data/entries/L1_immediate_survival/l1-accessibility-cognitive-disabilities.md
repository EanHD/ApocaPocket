...
Routine signals safety for people with cognitive disabilities.
- Post a simple daily schedule using pictures or large text.
...
Break every task into single numbered steps.
- "Step 1: Pick up the cup." Wait. Then give step 2.
- Demonstrate first, then guide, then let them try alone.
- Give choices of 2: "Red cup or blue cup?"
- Never stack instructions. Finish one before starting next.
- Praise each step. Positive feedback sustains cooperation.
