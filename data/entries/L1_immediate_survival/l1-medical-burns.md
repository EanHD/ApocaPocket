...
region_relevance:
- global
summary: Immediate burn response emphasizing cooling, contamination control, and escalation
  triggers with burn classification and treatment protocols.
steps:
- Remove from heat source and stop burning process immediately.
- Assess burn depth (superficial, partial-thickness, full-thickness) and extent (Rule of 9s).
- Cool with clean running water 10-20 minutes; avoid ice.
- Remove jewelry/constrictive items before swelling occurs.
- Cover with clean non-adherent dressing or clean cloth.
- Monitor for airway involvement, shock, and circulation issues.
- Provide pain relief and prevent hypothermia during cooling.
warnings:
- Chemical/electrical burns need specialized management - chemical burns require 20+ minutes continuous flushing.
- Large burns (>10% body surface area) require urgent evacuation.
- Circumferential burns can compromise circulation - monitor pulses distal to burn.
- Inhalation injury suspected if burned in enclosed space - evacuate immediately.
...
- advanced-trauma-life-support-2020
last_verified: '2026-02-19'
last_audit: '2026-02-19'
confidence: high
offline_assets:
- assets/diagrams/L1/medical/burns.png
---
